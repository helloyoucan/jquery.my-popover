...
(function () {
    ...
    Popover.prototype._addStyle = function () {
        ...
        this.$style.append(
            '.select-popover {position: fixed;width: 100px;z-index: 9999;}' +
    ...
    Popover.prototype._addEvent = function () {
        ...
        $that.on('click', function (e) {
            ...
            that._addDom();
            var size = {
                top: $(this).offset().top - Math.max($('html').scrollTop(), $('body').scrollTop()),
                left: $(this).offset().left - Math.max($('html').scrollLeft(), $('body').scrollLeft()),
